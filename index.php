...
<?php  
    ...
    if(isset($_POST['submitt'])){  
        ...
        if($password == $confirmPassword){  
            ...
            echo "<script>alert('Password Not Mnnnnatch')</script>";  
            ...
            <div class="col-lg-7 bg-white p-4">
              ...
              <form action="#" method="post" class="px-3" id="login-form">
                ...
                <div class="form-group">
                  <input type="submit" id="login-btn" value="Sign In" name="submit" class="btn btn-primary btn-lg btn-block myBtn" />
                </div>
              </form>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-7 bg-white p-4">
              ...
              <form action="#" method="post" class="px-3" id="register-form">
                ...
                <div class="form-group">
                  <input type="submit" id="registerr-btn" name="submitt" value="Sign Up" class="btn btn-primary btn-lg btn-block myBtn" />
                </div>
              </form>
            </div>
          </div>
